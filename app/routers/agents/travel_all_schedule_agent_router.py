...
travle_schedule_agent_serive = TravelScheduleAgentService()
...
async def generate_plan(
    ...
    try:
        ...
        if "site" in agent_type:
            external_data["site"] = create_tourist_plan(input_dict)
        ...
        result = await travle_schedule_agent_serive.create_plan(input_dict)
