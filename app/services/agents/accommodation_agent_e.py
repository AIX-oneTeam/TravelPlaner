...
first_llm_prompt = ChatPromptTemplate.from_template(
    ...
    3. Availability for the provided schedule
    """
)
...
second_llm_prompt = ChatPromptTemplate.from_template(
    ...
    4. The reason why you picked this accommodation
    """
)
...
async def run_prompts():
    ...
    first_response = await first_chain.arun(region="Daejeon, KOREA", date="2025/02/02-2025/02/05")
