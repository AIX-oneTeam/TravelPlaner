...
Notes:
1. Recommend real, well-known places, but also include lesser-known but interesting places.
...
async def get_recommendations(user_input: UserInput):
    try:
        ...
        async def get_details_for_place(place, day, order):
            ...
            try:
                ...
                if "존재하지 않는 장소" in detail_text:
                    ...
                    # Validate or provide placeholder for image URL
        ...
        # Filter out invalid or repetitive recommendations
