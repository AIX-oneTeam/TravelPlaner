...
# GeoCoordinateTool: 위도와 경도를 계산하는 툴
...
# GoogleMapSearchTool: 구글 맵 API를 사용한 검색 툴
...
# GoogleHotelSearchTool: 구글 호텔 API를 사용한 검색 툴
...
# GoogleReviewTool: 구글 리뷰 API를 사용하여 텍스트 정보를 검색
...
# AiLatestDevelopment: Crew와 Agent 설정
@CrewBase
